...
public class ClientSetting extends Module {
    ...
    public final StringSetting windowTitle = add(new StringSetting("WindowTitle", Supernova.NAME, () -> page.is(Page.Misc)));
    ...
    public final StringSetting hackName = add(new StringSetting("Notification", "[Supernova]", () -> page.getValue() == Page.Notification));
