...
import cc.supernova.api.interfaces.IShaderEffect;
...
public class ShaderManager implements Wrapper {
    ...
    public void setupShader(Shader shader, ManagedShaderEffect effect) {
        cc.supernova.mod.modules.impl.render.Shader shaderChams = cc.supernova.mod.modules.impl.render.Shader.INSTANCE;
